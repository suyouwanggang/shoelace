 ...
 * @returns
 */
declare function onEvent(node: Element | Document | Window, selector: string, type: string, callBack: EventListener, userCapture?: boolean, context?: unknown): {
    dispose: () => void;
};
/**
 * 模拟jquery on 事件
 ...
 * @returns
 */
declare function onEventArray(node: Element | Document | Window, selector: string, eventTypes: string[], callBack: EventListener, userCapture?: boolean, context?: unknown): {
    dispose: () => void;
}[];
