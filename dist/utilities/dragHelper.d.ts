 ...
 * @param callBack 回调 (changePos:Poniter,event:MouseEvent)
 */
export declare const dragOnHandler: (dragDiv: HTMLElement, selector: string, callBack: (changePos: Poniter, event: MouseEvent) => void, endBack?: (event: MouseEvent) => void) => {
    dispose: () => void;
};
//# sourceMappingURL=dragHelper.d.ts.map