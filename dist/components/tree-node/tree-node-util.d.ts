 ...
 */
export declare const iteratorNodeData: (data: TreeNodeData, callback: NodeVistor, parentData?: TreeNodeData, parentChildrenIndex?: number) => void;
/**
...
export {};
//# sourceMappingURL=tree-node-util.d.ts.map