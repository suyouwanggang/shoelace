...
export declare const getReisterColTemplate: (type: string) => (column: SlColumn, table: SlTable) => TemplateResult<1>;
...
export declare const getReisterCellTemplate: (type: string) => (context: CellContext, table: SlTable) => TemplateResult<1>;
