...
*
*/
export const chooseArray = (value, casesList, result, defaultCase) => {
    ...
    return isFunction(defaultCase) ? defaultCase === null || defaultCase === void 0 ? void 0 : defaultCase() : defaultCase;
};
/**
 * 将数据 t转化为value 输出
* @example
...
export const when = (condition, trueCase, falseCase) => {
    return condition ? isFunction(trueCase) ? trueCase() : trueCase : isFunction(falseCase) ? falseCase === null || falseCase === void 0 ? void 0 : falseCase() : falseCase;
};
