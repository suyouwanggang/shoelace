 ...
 */
export declare const hide: (_option?: HideShowOption | undefined) => import("lit/directive.js").DirectiveResult<typeof HideDirective>;
export declare const show: (_option?: HideShowOption | undefined) => import("lit/directive.js").DirectiveResult<typeof ShowDirective>;
export declare const doAnimate: (_option: AnimateOption) => import("lit/directive.js").DirectiveResult<typeof AnimateDirective>;
export {};
