...
export declare const doHideAnimate: (element: HTMLElement, options: KeyframeAnimationOptions, resovle?: () => void) => void;
export declare const doShowAnimate: (element: HTMLElement, options: KeyframeAnimationOptions, resovle?: () => void) => void;
 ...
 */
export declare const hide: (_option?: HideShowOption) => import("lit-html/directive").DirectiveResult<typeof HideDirective>;
export declare const show: (_option?: HideShowOption) => import("lit-html/directive").DirectiveResult<typeof ShowDirective>;
