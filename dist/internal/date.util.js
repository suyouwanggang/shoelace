 ...
 * @returns
 */
export const getDateYearMonthDay = (d) => {
 ...
 * @returns
 */
export const parseDate = (dateString, type = 'date') => {
 ...
 * @param month ，默认从1 开始
 */
export const getDaysPanel = (year, month = 1) => {
 ...
 * @returns
 */
export const isEqualsDate = (d1, d2, mode = 'date') => {
