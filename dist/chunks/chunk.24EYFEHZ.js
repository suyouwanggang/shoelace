...
var SlTree = class extends LitElement {
  ...
  renderAllTreeNode() {
    if (!this.renderRootNodeData) {
      ...
      if (this.includeRoot) {
        ...
        return children ? children.map((item, index) => this.renderNodeDataTemplate(item, index, this.renderRootNodeData)) : nothing;
      }
    }
  }
  renderNodeDataTemplate(data, index, parentData) {
    const tree = this;
    return html`<sl-tree-node .customStyle=${this.customStyle} .tree=${tree} .nodeData=${data} index=${index} .parentNodeData=${parentData} .nodeRender=${this.real_treeNodeRender}></sl-tree-node>`;
  }
  ...
  render() {
    ...
    return html`<div part="base" class=${classMap(baseClass)}>
      ${this.enableFilter ? html`<div part="filter">
      ...
      ${this.loading ? html`<div class="modal" part="modal">
...
__decorateClass([
  property({ reflect: true, attribute: "include_root", type: Boolean })
], SlTree.prototype, "includeRoot", 2);
__decorateClass([
  property({ reflect: true, attribute: "check_casecade", type: Boolean })
], SlTree.prototype, "checkCasecade", 2);
__decorateClass([
  property({ reflect: true, attribute: "check_off_casecade", type: Boolean })
], SlTree.prototype, "checkOffCasecade", 2);
__decorateClass([
  property({ reflect: true, attribute: "loading", type: Boolean })
...
__decorateClass([
  property({ attribute: "filter-input-placeholder" })
], SlTree.prototype, "filterInputPlaceholder", 2);
__decorateClass([
  property({ attribute: false })
], SlTree.prototype, "filterMethod", 2);
__decorateClass([
  property({ reflect: true, attribute: "enable-filter", type: Boolean })
