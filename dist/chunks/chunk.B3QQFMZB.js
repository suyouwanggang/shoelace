...
// src/components/scroll/scroll.ts
var SlScroll = class extends LitElement {
  constructor() {
    super(...arguments);
    this.overflowX = "";
    this.overflowY = "";
...
__decorateClass([
  property({ type: String, reflect: true, attribute: "overflow-x" })
], SlScroll.prototype, "overflowX", 2);
__decorateClass([
  property({ type: String, reflect: true, attribute: "overflow-y" })
], SlScroll.prototype, "overflowY", 2);
__decorateClass([
  property({ type: Boolean, reflect: true })
], SlScroll.prototype, "keyEnable", 2);
__decorateClass([
  property({ type: Number, reflect: true, attribute: "scroll-bar-width" })
], SlScroll.prototype, "scrollBarWidth", 2);
__decorateClass([
  property({ type: Number, reflect: true, attribute: "scroll-bar-out-width" })
