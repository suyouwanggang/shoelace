...
var SlDate = class extends s {
  ...
  render() {
    return p` <sl-dropdown .distance=${this.distance} id="dropDown" part="dropDown" .placement=${this.placement} .hoist=${this.hoist} .disabled=${this.readonly || this.disabled}>
      <sl-input
        slot="trigger"
        part="sl-date-input"
