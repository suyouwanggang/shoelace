    ...
    return renderFormControl({
      ...
      hasHelpTextSlot: this.hasHelpTextSlot
          ...
          >
            ...
            ${this.clearable && hasSelection ? html` <sl-icon-button exportparts="base:clear-button" class="select__clear" name="x-circle" library="system" @click=${this.handleClearClick} tabindex="-1"></sl-icon-button> ` : ""}
