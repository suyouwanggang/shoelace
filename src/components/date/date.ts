...
export default class SlDate extends LitElement {
 ...
 private handlerInputClick(event:InputEvent){
  ...
  render() {
    return html`<sl-dropdown .distance=${this.distance}
    id='dropDown' part='dropDown' .placement=${this.placement}  .hoist=${this.hoist} .disabled=${this.readonly||this.disabled} >
            <sl-input  part='sl-date-input' exportparts='base:input'    @sl-change=${this.handlerInputClick} 
            .value=${this.valueDateString} 
              .pill=${this.pill} .readonly=${this.readonly} 
              .disabled=${this.disabled} 
              .invalid=${this.invalid}
             .size=${this.size} slot='trigger'>${this.valueDateString}
