 ...
 */
export const vituralScrollCal=(contentHeight:number,size:number,rowHeight:number,scrollTop:number):VitrurlResult=>{
    ...
    if(firstSkipRows>2*viewCanShowRows){//向上多显示几倍视窗高度的内容
...
(window as any).vituralScrollCal=vituralScrollCal;