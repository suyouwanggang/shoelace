...
registDefaultEditor(EDIT_TYPE.INPUT,(context)=>{
    ...
    return html`<sl-input  size='small'   class='edit_input edit_field_${column.field}' .maxlength=${column.inputMaxLength} .value=${live(String(value))}
...
registDefaultEditor(EDIT_TYPE.TEXT,(context)=>{
    ...
    return html`<sl-textarea  class='edit_text edit_field_${column.field}'
...
registDefaultEditor(EDIT_TYPE.SELECT,(context)=>{
    ...
    return html`<sl-select size='small' hoist class='edit_select edit_field_${column.field}'
...
registDefaultEditor(EDIT_TYPE.MULIT_SELECT,(context)=>{
    ...
    return html`<sl-select size='small' multiple clearable hoist class='edit_select edit_field_${column.field}'
        .value=${array}
        @sl-change=${(event:Event)=>{
            if(column.field){
...
registDefaultEditor(EDIT_TYPE.MULIT_CHECKBOX,(context)=>{
    ...
    return html`<div ${ref(refObj)} multiple hoist class='edit_select edit_field_${column.field}' @sl-change=${(event:Event)=>{
        debugger;
...
registDefaultEditor(EDIT_TYPE.DATE,(context)=>{
   ...
   // style='max-width: var(--sl-column-width-${column.field})'
    ...
    ><sl-date block  size='small' .mode=${mode}  class='edit_date edit_field_${column.field}'
        .value=${live(value)}
