...
<sl-table id='tableDIV' >
    <sl-column field='name' label='Name' align='center' min-width='200'></sl-column>
...
<script >
    ...
    const dateList=[
                { id: 10001, name: 'Test1', role: 'Test1', sex: 'Man', age: 28, address: 'vxe-table 从入门到放弃' },
                { id: 10001, name: 'Test1', role: 'Test2', sex: 'Man', age: 28, address: 'vxe-table 从入门到放弃' },
    ...
    table.customStyle=`
        ...
        .green{
          background-color:rgb(var(--sl-color-primary-200));
        }
        .name{
            font-weight:bold;
        }
