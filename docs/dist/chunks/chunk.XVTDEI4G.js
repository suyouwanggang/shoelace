...
var SlTab = class extends s {
  ...
  render() {
    ...
    return p`
      ...
      >
        <slot></slot>
        ${this.closable ? p` <sl-icon-button name="x" library="system" label="Close" exportparts="base:close-button" class="tab__close-button" @click=${this.handleCloseClick} tabindex="-1"></sl-icon-button> ` : ""}
      </div>
    `;
  }
};
