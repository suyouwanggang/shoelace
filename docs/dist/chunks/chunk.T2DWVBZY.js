    ...
    const colorPicker = p`
      ...
      "--preview-color": `hsla(${this.hue}deg, ${this.saturation}%, ${this.lightness}%, ${this.alpha / 100})`
        ...
        <div class="color-picker__user-input">
          ...
          ${!this.noFormatToggle ? p` <sl-button exportparts="base:format-button" @click=${this.handleFormatToggle}> ${this.setLetterCase(this.format)} </sl-button> ` : ""}
        </div>
