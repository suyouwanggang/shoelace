    ...
    return renderFormControl({
      ...
      hasHelpTextSlot: this.hasHelpTextSlot
          ...
          >
            ...
            <div class="select__label">${this.displayTags.length ? p` <span part="tags" class="select__tags"> ${this.displayTags} </span> ` : this.displayLabel || this.placeholder}</div>
