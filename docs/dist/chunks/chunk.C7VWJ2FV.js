...
var color_picker_styles_default = r`
  ...
  .color-picker__transparent-bg {
      linear-gradient(45deg, rgb(var(--sl-color-neutral-300)) 25%, transparent 25%);    background-size: 10px 10px;
...
var SlColorPicker = class extends s {
  ...
  render() {
    ...
    const colorPicker = p`
      ...
      >
        <div part="grid" class="color-picker__grid" style=${i2({ backgroundColor: `hsl(${this.hue}deg, 100%, 50%)` })} @mousedown=${this.handleGridDrag} @touchstart=${this.handleGridDrag}>
          <span
            part="grid-handle"
      ...
      "--preview-color": `hsla(${this.hue}deg, ${this.saturation}%, ${this.lightness}%, ${this.alpha / 100})`
        ...
        <div class="color-picker__user-input">
          ...
          <sl-button-group>
            ${!this.noFormatToggle ? p` <sl-button aria-label="Change format" exportparts="base:format-button" @click=${this.handleFormatToggle}> ${this.setLetterCase(this.format)} </sl-button> ` : ""}
            ${hasEyeDropper ? p`
