...
var d = e2(class extends i2 {
  constructor(t) {
    super(t), this.tt = /* @__PURE__ */ new WeakMap();
  }
  render(t) {
    return [t];
  }
  update(s3, [e3]) {
    if (v(this.it) && (!v(e3) || this.it.strings !== e3.strings)) {
      ...
      if (o === void 0) {
        ...
        o = x(w, s4), o.setConnected(false), this.tt.set(this.it.strings, o);
      }
  ...
  renderNodeData() {
    ...
    if (this.nodeData) {
      ...
      if (this.nodeData.icon) {
        result.push($`<sl-icon class="node-icon" part="node-icon" name=${this.nodeData.icon} library="system"> </sl-icon>`);
      }
