...
var SlScroll = class extends n {
  ...
  render() {
    return y`<div part="base" id="container" style="--scroll-bar-width:${this.scrollBarWidth}px ; --scroll-bar-out-width:${this.scrollBarOutWidth}px">
  ...
  disconnectedCallback() {
    ...
    (_a = this._obersver) == null ? void 0 : _a.unobserve(this.content_wrap_DIV);
    (_b = this._obersver) == null ? void 0 : _b.unobserve(this);
    this._obersver = void 0;
  ...
  _initScrollBarEvent() {
    ...
    const dragFun = (scrollDiv, callBackFun) => {
      ...
      const handerMove = (event) => {
        ...
        callBackFun(nX - x, nY - y2);
        x = nX;
        y2 = nY;
      };
      scrollDiv.addEventListener("mousedown", handerDown);
    };
    dragFun(scrollObj.partYHandler, (_x, y2) => {
      scrollObj.changeYBarPosition(y2);
    });
  ...
  _intiKeyEvent() {
    ...
    this._docEventHandler = (event) => {
      if (this._isMouseOn && this.keyEnable) {
        ...
        switch (key) {
          case "ArrowDown":
            y2 = this.scrollItemValue;
            break;
          case "ArrowUp":
            y2 = 0 - this.scrollItemValue;
            break;
          case "ArrowLeft":
...
var scroll_default2 = SlScroll;

export {
  scroll_default2 as scroll_default
};
