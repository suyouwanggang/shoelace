  ...
  syncItemsFromValue() {
    ...
    if (this.multiple) {
      ...
      if (this.maxTagsVisible > 0 && this.displayTags.length > this.maxTagsVisible) {
        ...
        this.displayTags.push(y` <sl-tag exportparts="base:tag" type="neutral" size=${this.size}> +${total - this.maxTagsVisible} </sl-tag> `);
      }
    } else {
    ...
    return renderFormControl({
      ...
      hasHelpTextSlot: this.hasHelpTextSlot
          ...
          >
            ...
            <div part="select_label" class="select__label">${this.displayTags.length ? y` <span part="tags" class="select__tags"> ${this.displayTags} </span> ` : this.displayLabel || this.placeholder}</div>

            ${this.clearable && hasSelection ? y` <sl-icon-button exportparts="base:clear-button" class="select__clear" name="x-circle" library="system" @click=${this.handleClearClick} tabindex="-1"></sl-icon-button> ` : ""}
