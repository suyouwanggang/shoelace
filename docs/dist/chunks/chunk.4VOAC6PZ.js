...
var SlOrgTree = class extends n {
  ...
  render() {
    const tree = this;
    return y`<div class="org-tree-container " id="container" part="container">
      <div class="org-tree collapsable ${this.horizontal ? "horizontal" : ""}" part="tree">
        ${this.rootData ? y`<sl-org-node
              id="root"
              class="org-tree-node"
