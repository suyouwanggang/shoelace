...
export declare const getColumnCellRenderTemplate: (context: CellContext, table: SlTable) => typeof nothing | TemplateResult<1> | {
...
export declare const renderTdCellTemplate: (context: CellContext, table: SlTable) => typeof nothing | TemplateResult<1>;
